...
--project-name spliceai_pytorch_prediction_rs${RANDOPM_SEED} \
--test-dataset /home/kchao10/data_ssalzbe1/khchao/data/train_test_dataset_${SPECIES}_test/dataset_test.h5 \
