...
spliceai-toolkit train --flanking-size 400 \
...
--random-seed 11 \
--model SpliceAI \
--loss cross_entropy_loss > train_spliceai-MANE-400nt_adeptive_lr_rs11.log 2> train_spliceai-MANE-400nt_adeptive_lr_rs11_error.log