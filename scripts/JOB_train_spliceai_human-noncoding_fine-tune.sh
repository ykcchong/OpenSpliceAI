...
mkdir /home/kchao10/data_ssalzbe1/khchao/spliceAI-toolkit/results/model_train_outdir/SpliceAI_${LOSS_FUNC}_${SPECIES}_fine-tune_${FLANKING_SIZE}_${EXP_NUM}_rs${RANDOPM_SEED}/
...
--project-name ${SPECIES}_fine-tune \
...
--loss ${LOSS_FUNC} > /home/kchao10/data_ssalzbe1/khchao/spliceAI-toolkit/results/model_train_outdir/SpliceAI_${LOSS_FUNC}_${SPECIES}_fine-tune_${FLANKING_SIZE}_${EXP_NUM}_rs${RANDOPM_SEED}/train.log 2> /home/kchao10/data_ssalzbe1/khchao/spliceAI-toolkit/results/model_train_outdir/SpliceAI_${LOSS_FUNC}_${SPECIES}_fine-tune_${FLANKING_SIZE}_${EXP_NUM}_rs${RANDOPM_SEED}/train_error.log
