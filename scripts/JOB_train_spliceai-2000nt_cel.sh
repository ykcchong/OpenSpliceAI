...
spliceai-toolkit train --flanking-size 2000 \
...
--random-seed 12 \
--model SpliceAI \
--loss cross_entropy_loss > train_spliceai-MANE-2000nt_adeptive_lr_rs12.log 2> train_spliceai-MANE-2000nt_adeptive_lr_rs12_error.log