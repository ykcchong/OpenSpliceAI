...
# OUTPUT_DIR="../results/train_outdir/${CURRENT_SPECIES}/flanking_${FLANKING_SIZE}"
...
# OUTPUT_FILE="$EXP_DIR/test_output.log"
# ERROR_FILE="$EXP_DIR/test_error.log"

# 2. No paralogs removed
# OUTPUT_DIR="../results/train_no_paralog_removal_outdir/${CURRENT_SPECIES}/flanking_${FLANKING_SIZE}"
# # Set up dataset paths (adjust these as needed for each species)
...
# EXP_DIR=$OUTPUT_DIR/SpliceAI_${CURRENT_SPECIES}_train_${FLANKING_SIZE}_${EXP_NUM}_rs${RANDOM_SEED}
# OUTPUT_FILE="$EXP_DIR/test_output_no_paralogs_removed.log"
# ERROR_FILE="$EXP_DIR/test_error_no_paralogs_removed.log"

# # 4. SpliceAI default No paralogs removed
# OUTPUT_DIR="../results/train_lsspliceai_default_no_paralog_removal_outdir/${CURRENT_SPECIES}/flanking_${FLANKING_SIZE}"
# # Set up dataset paths (adjust these as needed for each species)
...
# EXP_DIR=$OUTPUT_DIR/SpliceAI_${CURRENT_SPECIES}_train_${FLANKING_SIZE}_${EXP_NUM}_rs${RANDOM_SEED}
# OUTPUT_FILE="$EXP_DIR/test_spliceai_default_no_paralog_removed_output.log"
# ERROR_FILE="$EXP_DIR/test_spliceai_default_no_paralog_removed_error.log"
...
# EXP_DIR=$OUTPUT_DIR/SpliceAI_${CURRENT_SPECIES}_train_${FLANKING_SIZE}_${EXP_NUM}_rs${RANDOM_SEED}
# PRETRAINED_MODEL="/home/kchao10/data_ssalzbe1/khchao/OpenSpliceAI/results/train_spliceai_default_no_paralog_removal_outdir/${CURRENT_SPECIES}/flanking_${FLANKING_SIZE}/SpliceAI_${CURRENT_SPECIES}_train_${FLANKING_SIZE}_${EXP_NUM}_rs${RANDOM_SEED}/${EXP_NUM}/models/model_best.pt"

# 8. SpliceAI-keras cleaned test dataset
OUTPUT_DIR="../results/test_outdir/clean_test_dataset_SpliceAI-keras_model/${CURRENT_SPECIES}/flanking_${FLANKING_SIZE}"
TEST_DATASET="/home/kchao10/data_ssalzbe1/khchao/OpenSpliceAI/experiments/remove_paralogs_in_testset/filtered_test_dataset.h5"
EXP_DIR=$OUTPUT_DIR/SpliceAI_${CURRENT_SPECIES}_train_${FLANKING_SIZE}_${EXP_NUM}_rs${RANDOM_SEED}
PRETRAINED_MODEL="/home/kchao10/data_ssalzbe1/khchao/OpenSpliceAI/results/train_outdir/SpliceAI-keras_data/${CURRENT_SPECIES}/flanking_${FLANKING_SIZE}/SpliceAI_${CURRENT_SPECIES}_train_${FLANKING_SIZE}_${EXP_NUM}_rs${RANDOM_SEED}/${EXP_NUM}/models/model_best.pt"

OUTPUT_FILE="$EXP_DIR/test_output.log"
ERROR_FILE="$EXP_DIR/test_error.log"

# rm -rf $EXP_DIR/$EXP_NUM/TEST_LOG

mkdir -p $OUTPUT_DIR
mkdir -p ${EXP_DIR}
# PRETRAINED_MODEL="$EXP_DIR/$EXP_NUM/models/model_best.pt"
