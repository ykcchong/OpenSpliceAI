...
openspliceai fine-tune --flanking-size 400 \
--early-stopping \
...
--pretrained-model  /home/kchao10/data_ssalzbe1/khchao/OpenSpliceAI/models/spliceai-mane/400nt/model_400nt_rs12.pt \
--random-seed 11 \
