'''Script to extract all splice sites in pc genes in fasta given gff'''
...
def extract_sequences(fasta_file, gff_file, output_donor, output_acceptor, db_file, seq_length=400):
    # Load the FASTA file
...
if __name__ == '__main__':
    ...
    db = 'experiments/mutagenesis/experiment_2/data/chr1.db'
    
    seq_length = 400 + 10000
    extract_sequences(fasta, gff, donor, acceptor, db, seq_length)