...
def plot_donor_acceptor_sites(acceptor_scores_ref,donor_scores_ref, output_dir):
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(output_dir, 'donor_acceptor_sites.png'), dpi=300)
    plt.show()
...
def exp_1(fasta_file, models, model_type, flanking_size, output_dir, device):
    ...
    plot_donor_acceptor_sites(acceptor_scores_ref, donor_scores_ref, output_dir)
...
def mutagenesis():
    ...
    for model_type, flanking_size in itertools.product(model_types, flanking_sizes):
        ...
        exp_1(fasta_file, models, model_type, flanking_size, output_dir, device)
