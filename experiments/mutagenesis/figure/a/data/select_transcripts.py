...
def specific_extract_GRCh37(chrom, start, stop, output_dir):
...
# include flanking
# specific_extract_GRCh37(3, 142740137-5000, 142740263+5000, 'experiments/mutagenesis/experiment_3/data')
...
specific_extract_GRCh38(6, 56735192-5000, 56735344+5000, 'experiments/mutagenesis/experiment_3/data', '-')
