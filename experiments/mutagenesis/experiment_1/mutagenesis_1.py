...
def mutagenesis():
    ...
    for model_type, flanking_size in itertools.product(model_types, flanking_sizes):
        ...
        fasta_file = f'/ccb/cybertron/smao10/openspliceai/experiments/mutagenesis/experiment_1/data/{sample}.fa'
        
        # Initialize params
        output_dir = f"/ccb/cybertron/smao10/openspliceai/experiments/mutagenesis/experiment_1/results/exp_{exp_number}/{model_type}_{flanking_size}_{sample}"
