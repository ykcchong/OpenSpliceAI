...
class ModelWithTemperature(nn.Module):
    ...
    def __init__(self, model):
        super().__init__()
        self.model = model
        self.temperature = nn.Parameter(torch.ones(1) * 1.1)  # Initialized to 1.5
    ...
    def set_temperature(self, valid_loader, params):
        ...
        for epoch in range(max_epochs):
            ...
            print(f"Epoch {epoch+1}/{max_epochs}, Loss: {current_loss:.6f}, Temperature: {self.temperature.item():.4f}, Learning Rate: {current_lr:.6f}")
...
#         torch.save(temperature, filepath)
#         print(f"Temperature saved to {filepath}")
