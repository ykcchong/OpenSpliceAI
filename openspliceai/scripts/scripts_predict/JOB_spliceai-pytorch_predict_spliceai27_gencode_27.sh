...
for FLANKING_SIZE in 80 400 2000 10000; do
    ...
    --model /home/kchao10/data_ssalzbe1/khchao/spliceAI-toolkit/results/model_train_outdir/SpliceAI_cross_entropy_loss_SpliceAI27_cross_entropy_loss_w0_${FLANKING_SIZE}_full_dataset_rs${RANDOPM_SEED}/full_dataset/models/best_model.pt
done
