...
for num in 11 12 22 40 42; do
    python predict_spliceaitoolkit.py --flanking-size 80 \
    ...
    --model /home/kchao10/data_ssalzbe1/khchao/spliceAI-toolkit/models/spliceai-mane/80nt/model_80nt_rs$num.pt
done

# dataset /home/kchao10/data_ssalzbe1/khchao/data/train_test_dataset_MANE/dataset_test.h5 \

# python predict_spliceai27.py --flanking-size 80 \
