...
python conformal_prediction_spliceaitoolkit.py --flanking-size 10000 \
...
--output-dir /home/kchao10/data_ssalzbe1/khchao/spliceAI-toolkit/results/model_conformal_prediction_outdir/ \
